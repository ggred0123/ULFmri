#!/bin/bash
# CONTROL RUN: identical to v5 except the text conditioning is removed -- every
...
NULL_EMBEDS=${NULL_EMBEDS:-$ROOT/data_stage0_3ori_latents/null_embeds.pt}
VAE_PATH=${VAE_PATH:-$ROOT/sd3_local/vae}
OUTPUT_DIR=${OUTPUT_DIR:-stage0_notext_ctrl}
